...
model_path = os.getenv("MODEL_PATH", "/app/model")  # Use environment variable for model path
try:
...
primary_labels = ['Depression', 'Anger', 'Mania', 'Anxiety', 'Somatic Symptoms', 
                  'Suicidal Ideation', 'Psychosis', 'Sleep Problems', 
